    ...
    <header className="sticky top-0 z-50 w-full border-b border-black/10 dark:border-white/10 bg-white/80 dark:bg-[#0c0a1f]/75 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2.5">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-black dark:bg-gradient-to-br dark:from-indigo-500 dark:to-purple-500 shadow-lg shadow-black/20 dark:shadow-indigo-500/20">
